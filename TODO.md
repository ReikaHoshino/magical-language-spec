...
- active concrete work: **IN PROGRESS — public Issue #23 / draft public PR #27 v1.0 execution-admission semantics on `agent/public-issue-23-execution-admission`; public Issue #3 final `v1.0.0` is blocked until landing plus renewed release gate/new RC decision**。
